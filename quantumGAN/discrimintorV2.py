...
class DiscriminatorV2:
	def __init__(self, in_features, out_features):
		...
		self.architecture = [
			{"input_dim": self.in_features, "output_dim": 16, "activation": "relu"},
			{"input_dim": 16, "output_dim": 3, "activation": "relu"},
			{"input_dim": 3, "output_dim": self.out_features, "activation": "sigmoid"},
		]
