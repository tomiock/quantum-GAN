...
Aquest projecte de \href{www.python.org}{Python} el vaig començar a desenvolupar mitjançant una \href{https://jupyter.org/}{Jupyter Notebook}, a través de \href{https://colab.research.google.com/}{Google Colab}, però degut a que el projecte va augmentar de mida i necesitava més eines (com un \textit{debugger}\footnote{Un \textit{debugger} és una eina que serveix per diagnosticar i arreglar problemes en el codi, és extremadament útil. }), vaig decidir passar-me a un IDE (\textit{Integrated Development Environment}), un programa que facilita la feina del programador amb l'objectiu de ser més eficient. Vaig decidir-me per un IDE expressament dissenyat per a Python, \href{https://www.jetbrains.com/pycharm/}{PyCharm}, creat per JetBrains. Concretament per la versió \textit{community}, que és d'ús gratuït. Per poder manejar els paquets de Python, vaig veure que existien programes com \href{https://www.anaconda.com/products/individual}{Anaconda}, per tant també el vaig instal·lar. 

Els paquets que són necessaris per executar el codi estan especificats en el \href{https://github.com/tomiock/quantum-GAN/network/dependencies}{repositori del treball}. Tota l'informació corresponent a aquest treball es pot trobar en aquest. Des dels arxius de \LaTeX \, fins als canvis que vaig anar fent al llarg del treball. 
