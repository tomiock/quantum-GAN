...
\begin{document}
	...
	Aquest document ha estat pensat per llegir-lo en un PDF, tot el text que està marcat en blau és hipertext que apunta a un enllaç web o a una altra part del treball. Si el lector vol accedir al enllaços web ho pot fer a partir del PDF, que el trobarà en a: \href{https://github.com/tomiock/qGAN}
